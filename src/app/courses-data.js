export const courses = [
  {
    ...
    title: "US History",
    images : [
      { src: './assets/course-banners/us-history-banner.webp', alt: 'Slide 1' },
  ...
  },
  {
    ...
    images : [
      { src: './assets/course-banners/english-banner.webp', alt: 'Slide 1' },
      { src: '../assets/algebra-course.webp', alt: 'Slide 2' },
      { src: '../assets/PMM.webp', alt: 'Slide 3' }
    ],
  ...
  },
  {
    ...
    title: "Algebra",
    images : [
      { src: './assets/course-banners/algebra-banner.webp', alt: 'Slide 1' },
      { src: '../assets/algebra-course.webp', alt: 'Slide 2' },
      { src: '../assets/PMM.webp', alt: 'Slide 3' }
    ],
   // image: "./assets/course-banners/algebra-banner.webp",
  ...
  },
  {
    ...
    images : [
      { src: '/assets/course-banners/communications-banner.webp', alt: 'Slide 1' },
      { src: '../assets/algebra-course.webp', alt: 'Slide 2' },
      { src: '../assets/PMM.webp', alt: 'Slide 3' }
    ],
  ...
  },
  {
    ...
    images : [
      { src: '/assets/course-banners/project-management-banner.webp', alt: 'Slide 1' },
      { src: '../assets/algebra-course.webp', alt: 'Slide 2' },
      { src: '../assets/PMM.webp', alt: 'Slide 3' }
    ],
   // image: "./assets/course-banners/project-management-banner.webp",
